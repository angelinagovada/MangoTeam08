...
public class WatchList implements JsonSerializable {
    ...
    public List<DataPointVO> getPointList() {
        ...
        // Create a decimal format object with two decimal places
        DecimalFormat df = new DecimalFormat("#.##");

        // Create a new list to store formatted numbers
        List<String> formattedNumbers = new ArrayList<>();

        // Format each number in the list and store in formattedNumbers list
        for (Double number : DataPointVO) {
